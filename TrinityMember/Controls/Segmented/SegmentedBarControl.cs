...
namespace TrinityMember.Controls
{
    public class SegmentedBarControl : ContentView
    {
        ...
        void LoadChildrens()
        {
            ...
            foreach (var item in Children)
            {
                ...
                var boxview = new BoxView() { BackgroundColor = Color.Transparent, HeightRequest = 3, HorizontalOptions = LayoutOptions.StartAndExpand,WidthRequest=25,CornerRadius=2, Margin = new Thickness(10, 0) };
